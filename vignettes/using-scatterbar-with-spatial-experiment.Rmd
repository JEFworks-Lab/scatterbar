...
First, we need to loading the necessary libraries and load in the dataset provided by SEraster. It is a preprocessed MERFISH dataset of the mouse preoptic area from a female naive animal.
